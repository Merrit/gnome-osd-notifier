...
export class ElementFactory {
    ...
    create_with_properties(n: number, names?: string | null, values?: any): Element | null
    ...
    static make_with_properties(factoryname: string, n: number, names?: string | null, values?: any): Element | null
    static $gtype: GObject.Type
}
