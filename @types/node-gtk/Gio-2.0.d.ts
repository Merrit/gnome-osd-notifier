...
export class DBusObjectManager {
    ...
    vfuncGetInterface(objectPath: string, interfaceName: string): DBusInterface | null
    vfuncGetObject(objectPath: string): DBusObject | null
    vfuncGetObjectPath(): string
...
export class PollableInputStream {
    ...
    vfuncReadNonblocking(): [ /* returnType */ number, /* buffer */ any | null ]
