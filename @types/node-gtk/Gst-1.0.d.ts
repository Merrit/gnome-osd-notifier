...
export class Clock {
    ...
    vfuncWait(entry: ClockEntry): [ /* returnType */ ClockReturn, /* jitter */ ClockTimeDiff | null ]
...
export class ElementFactory {
    ...
    createWithProperties(n: number, names?: string | null, values?: any): Element | null
    ...
    static makeWithProperties(factoryname: string, n: number, names?: string | null, values?: any): Element | null
    static $gtype: GObject.Type
}
