...
export class DataModelBdb {
    ...
    vfuncGetDataPart(data: object | null, length: number, part: number): any
    vfuncGetKeyPart(data: object | null, length: number, part: number): any
    vfuncUpdateDataPart(data: object | null, length: number, part: number, value: any): boolean
    vfuncUpdateKeyPart(data: object | null, length: number, part: number, value: any): boolean
    vfuncAccessChanged(): void
    vfuncChanged(): void
    vfuncIAppendRow(): number
    vfuncIAppendValues(values?: any): number
...
export abstract class DataModelBdbClass {
    ...
    parentClass: GObject.ObjectClass
    getKeyPart: (model: DataModelBdb, data: object | null, length: number, part: number) => any
    getDataPart: (model: DataModelBdb, data: object | null, length: number, part: number) => any
    updateKeyPart: (model: DataModelBdb, data: object | null, length: number, part: number, value: any) => boolean
    updateDataPart: (model: DataModelBdb, data: object | null, length: number, part: number, value: any) => boolean
    static name: string
}
