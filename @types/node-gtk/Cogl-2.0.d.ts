...
export class Texture {
    ...
    allocate(): Bool
    copySubImage(xoffset: number, yoffset: number, x: number, y: number, width: number, height: number): Bool
...
export class GLES2Vtable {
    ...
    glBindTexture: (target: GL.enum, texture: GL.uint) => void
    glBlendFunc: (sfactor: GL.enum, dfactor: GL.enum) => void
    ...
    glColorMask: (red: GL.boolean, green: GL.boolean, blue: GL.boolean, alpha: GL.boolean) => void
    glCopyTexSubImage2D: (target: GL.enum, level: GL.int, xoffset: GL.int, yoffset: GL.int, x: GL.int, y: GL.int, width: GL.sizei, height: GL.sizei) => void
    glDeleteTextures: (n: GL.sizei, textures: GL.uint) => void
    glDepthFunc: (func: GL.enum) => void
    glDepthMask: (flag: GL.boolean) => void
    glDisable: (cap: GL.enum) => void
    glDrawArrays: (mode: GL.enum, first: GL.int, count: GL.sizei) => void
    glDrawElements: (mode: GL.enum, count: GL.sizei, type: GL.enum, indices: GL.void) => void
    glEnable: (cap: GL.enum) => void
    glFinish: () => void
    glFlush: () => void
    glFrontFace: (mode: GL.enum) => void
    glCullFace: (mode: GL.enum) => void
    glGenTextures: (n: GL.sizei, textures: GL.uint) => void
    glGetIntegerv: (pname: GL.enum, params: GL.int) => void
    glGetBooleanv: (pname: GL.enum, params: GL.boolean) => void
    glGetFloatv: (pname: GL.enum, params: GL.float) => void
    glHint: (target: GL.enum, mode: GL.enum) => void
    glPixelStorei: (pname: GL.enum, param: GL.int) => void
    glReadPixels: (x: GL.int, y: GL.int, width: GL.sizei, height: GL.sizei, format: GL.enum, type: GL.enum, pixels: GL.void) => void
    glScissor: (x: GL.int, y: GL.int, width: GL.sizei, height: GL.sizei) => void
    glStencilFunc: (func: GL.enum, ref: GL.int, mask: GL.uint) => void
    glStencilMask: (mask: GL.uint) => void
    glStencilOp: (fail: GL.enum, zfail: GL.enum, zpass: GL.enum) => void
    glTexImage2D: (target: GL.enum, level: GL.int, internalformat: GL.int, width: GL.sizei, height: GL.sizei, border: GL.int, format: GL.enum, type: GL.enum, pixels: GL.void) => void
    glTexParameterf: (target: GL.enum, pname: GL.enum, param: GL.float) => void
    glTexParameterfv: (target: GL.enum, pname: GL.enum, params: GL.float) => void
    glTexParameteri: (target: GL.enum, pname: GL.enum, param: GL.int) => void
    glTexParameteriv: (target: GL.enum, pname: GL.enum, params: GL.int) => void
    glGetTexParameterfv: (target: GL.enum, pname: GL.enum, params: GL.float) => void
    glGetTexParameteriv: (target: GL.enum, pname: GL.enum, params: GL.int) => void
    glTexSubImage2D: (target: GL.enum, level: GL.int, xoffset: GL.int, yoffset: GL.int, width: GL.sizei, height: GL.sizei, format: GL.enum, type: GL.enum, pixels: GL.void) => void
    glCopyTexImage2D: (target: GL.enum, level: GL.int, internalformat: GL.enum, x: GL.int, y: GL.int, width: GL.sizei, height: GL.sizei, border: GL.int) => void
    ...
    glCompressedTexImage2D: (target: GL.enum, level: GL.int, internalformat: GL.enum, width: GL.sizei, height: GL.sizei, border: GL.int, imageSize: GL.sizei, data: GL.void) => void
    glCompressedTexSubImage2D: (target: GL.enum, level: GL.int, xoffset: GL.int, yoffset: GL.int, width: GL.sizei, height: GL.sizei, format: GL.enum, imageSize: GL.sizei, data: GL.void) => void
    glSampleCoverage: (value: GL.clampf, invert: GL.boolean) => void
    glGetBufferParameteriv: (target: GL.enum, pname: GL.enum, params: GL.int) => void
    glGenBuffers: (n: GL.sizei, buffers: GL.uint) => void
    glBindBuffer: (target: GL.enum, buffer: GL.uint) => void
    glBufferData: (target: GL.enum, size: GL.sizeiptr, data: GL.void, usage: GL.enum) => void
    glBufferSubData: (target: GL.enum, offset: GL.intptr, size: GL.sizeiptr, data: GL.void) => void
    glDeleteBuffers: (n: GL.sizei, buffers: GL.uint) => void
    glActiveTexture: (texture: GL.enum) => void
    glGenRenderbuffers: (n: GL.sizei, renderbuffers: GL.uint) => void
    glDeleteRenderbuffers: (n: GL.sizei, renderbuffers: GL.uint) => void
    glBindRenderbuffer: (target: GL.enum, renderbuffer: GL.uint) => void
    glRenderbufferStorage: (target: GL.enum, internalformat: GL.enum, width: GL.sizei, height: GL.sizei) => void
    glGenFramebuffers: (n: GL.sizei, framebuffers: GL.uint) => void
    glBindFramebuffer: (target: GL.enum, framebuffer: GL.uint) => void
    glFramebufferTexture2D: (target: GL.enum, attachment: GL.enum, textarget: GL.enum, texture: GL.uint, level: GL.int) => void
    glFramebufferRenderbuffer: (target: GL.enum, attachment: GL.enum, renderbuffertarget: GL.enum, renderbuffer: GL.uint) => void
    glDeleteFramebuffers: (n: GL.sizei, framebuffers: GL.uint) => void
    glGenerateMipmap: (target: GL.enum) => void
    glGetFramebufferAttachmentParameteriv: (target: GL.enum, attachment: GL.enum, pname: GL.enum, params: GL.int) => void
    glGetRenderbufferParameteriv: (target: GL.enum, pname: GL.enum, params: GL.int) => void
    glBlendEquation: (mode: GL.enum) => void
    glBlendColor: (red: GL.clampf, green: GL.clampf, blue: GL.clampf, alpha: GL.clampf) => void
    glBlendFuncSeparate: (srcRGB: GL.enum, dstRGB: GL.enum, srcAlpha: GL.enum, dstAlpha: GL.enum) => void
    glBlendEquationSeparate: (modeRGB: GL.enum, modeAlpha: GL.enum) => void
    glReleaseShaderCompiler: () => void
    glGetShaderPrecisionFormat: (shadertype: GL.enum, precisiontype: GL.enum, range: GL.int, precision: GL.int) => void
    glShaderBinary: (n: GL.sizei, shaders: GL.uint, binaryformat: GL.enum, binary: GL.void, length: GL.sizei) => void
    glStencilFuncSeparate: (face: GL.enum, func: GL.enum, ref: GL.int, mask: GL.uint) => void
    glStencilMaskSeparate: (face: GL.enum, mask: GL.uint) => void
    glStencilOpSeparate: (face: GL.enum, fail: GL.enum, zfail: GL.enum, zpass: GL.enum) => void
    ...
    glGetShaderiv: (shader: GL.uint, pname: GL.enum, params: GL.int) => void
    glGetProgramiv: (program: GL.uint, pname: GL.enum, params: GL.int) => void
    ...
    glUniformMatrix2fv: (location: GL.int, count: GL.sizei, transpose: GL.boolean, value: GL.float) => void
    glUniformMatrix3fv: (location: GL.int, count: GL.sizei, transpose: GL.boolean, value: GL.float) => void
    glUniformMatrix4fv: (location: GL.int, count: GL.sizei, transpose: GL.boolean, value: GL.float) => void
    ...
    glVertexAttribPointer: (index: GL.uint, size: GL.int, type: GL.enum, normalized: GL.boolean, stride: GL.sizei, pointer: GL.void) => void
    ...
    glGetVertexAttribfv: (index: GL.uint, pname: GL.enum, params: GL.float) => void
    glGetVertexAttribiv: (index: GL.uint, pname: GL.enum, params: GL.int) => void
    glGetVertexAttribPointerv: (index: GL.uint, pname: GL.enum, pointer: GL.void) => void
    static name: string
}
